...
?>
<?=template_admin_header('Vezérlőpult', 'dashboard')?>
...
<div class="content-title">
    <div class="title">
        ...
        <div class="txt">
            <h2>Vezérlőpult</h2>
            <p>Statisztikák, új fiókok és további adatok megtekintése.</p>
        </div>
    </div>
</div>
...
<div class="dashboard">
    <div class="content-block stat">
        <div class="data">
            <h3>Új fiókok <span>&lt;1 nap</span></h3>
        ...
        <div class="footer">
            ...
            Ma létrehozott fiókok összesen
        </div>
    </div>
    ...
    <div class="content-block stat cyan">
        <div class="data">
            <h3>Aktív fiókok <span>&lt;30 nap</span></h3>
    ...
    <div class="content-block stat red">
        <div class="data">
            <h3>Inaktív fiókok <span>&gt;30 nap</span></h3>
...
<div class="content-title">
    <div class="title">
        ...
        <div class="txt">
            <h2>Új fiókok</h2>
            <p>Az elmúlt &lt;1 napban létrehozott fiókok.</p>
        </div>
    </div>
</div>
    ...
    <div class="table">
        <table>
            <thead>
                <tr>
                    <td>#</td>
                    <td colspan="2">Felhasználónév</td>
                    <td class="responsive-hidden">E-mail</td>
                    <td class="responsive-hidden">Állapot</td>
                    <td class="responsive-hidden">Szerepkör</td>
                    <td class="responsive-hidden">Utoljára aktív</td>
                    <td class="responsive-hidden">Regisztráció dátuma</td>
                    <td>Műveletek</td>
                </tr>
            </thead>
            <tbody>
...
<div class="content-title" style="margin-top:40px">
    <div class="title">
        ...
        <div class="txt">
            <h2>Aktív fiókok</h2>
            <p>Az elmúlt &lt;1 napban aktív fiókok.</p>
        </div>
    </div>
</div>
    ...
    <div class="table">
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td colspan="20" class="no-results">Nincsenek aktív fiókok.</td>
                </tr>
                <?php endif; ?>
