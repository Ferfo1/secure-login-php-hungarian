...
?>
<?=template_admin_header('Szerepkörök', 'roles')?>
...
<div class="content-title">
    <div class="title">
        ...
        <div class="txt">
            <h2>Szerepkörök</h2>
            <p>Szerepkörök és a hozzájuk tartozó fiókok száma.</p>
        </div>
    </div>
</div>
    ...
    <div class="table">
        <table>
            <thead>
                <tr>
                    <td>Szerepkör</td>
                    <td>Fiókok összesen</td>
                    <td>Aktív fiókok</td>
                    <td>Inaktív fiókok</td>
                </tr>
            </thead>
            <tbody>
                <?php if (!$roles): ?>
                <tr>
                    <td colspan="20" class="no-results">Nincsenek szerepkörök.</td>
                </tr>
                <?php endif; ?>
