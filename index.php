		...
		<div class="login">
			...
			<form action="authenticate.php" method="post" class="form login-form">
				...
				<div class="form-group pad-y-5">
					...
					<a href="forgot-password.php" class="form-link">Elfelejtett jelszó?</a>
				</div>
				
				<div class="msg"></div>

				<button class="btn blue" type="submit">Bejelentkezés</button>

				<p class="register-link">Nincs még fiókod? <a href="register.php" class="form-link">Regisztráció</a></p>
